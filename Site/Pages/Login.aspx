            ...
            <LayoutTemplate>
                ...
                <div class="col-md-4 col-md-offset-4">
                    <div class="input-group has-success">
                        ...
                        <asp:TextBox ID="UserName" class="form-control" runat="server" placeholder="Usuário" autofocus required></asp:TextBox>
                    ...
                    <div class="input-group has-success">
                        ...
                        <asp:TextBox ID="Password" class="form-control" runat="server" TextMode="Password" placeholder="Senha" required></asp:TextBox>
                    ...
                    <br />
                    <br />
                    <div class="text-center text-success"><a href="#">Recuperar Senha</a></div>
                </div>
            </LayoutTemplate>
        </asp:Login>
    </form>
